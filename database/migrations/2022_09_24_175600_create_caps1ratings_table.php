...
return new class extends Migration
{
     ...
     */
    public function up()
    {if(!Schema::hasTable('caps1ratings')){
        Schema::create('caps1ratings', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('capstone1_id')->unsigned();
            ...
            $table->foreign('capstone1_id')->references('id')->on('capstone1s')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('caps1ratings');
    }
};
